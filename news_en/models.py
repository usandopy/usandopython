...
class Author(models.Model):
    user = models.OneToOneField(User, related_name='author_en', on_delete=models.CASCADE)
...
class Category(models.Model):
    ...
    parent = models.ForeignKey('self', blank=True, null=True, on_delete=models.CASCADE, related_name='children_en')
    ...
    def get_absolute_url(self):
        return reverse("newspaper_en:category_en", kwargs={'slug': self.slug})


class News(models.Model):
    author = models.ForeignKey(Author, on_delete=models.CASCADE, related_name='author_en')
    ...
    category = models.ForeignKey(Category, on_delete=models.CASCADE, related_name='category_en')
    tags = TaggableManager(related_name='tags_en')
    ...
    def get_absolute_url(self):
        return reverse("newspaper_en:single-post_en", kwargs={'slug': self.slug})
