...
urlpatterns = [
    ...
    path('contacto', feedback, name='feedback'),
    path('categoria/<slug:category_slug>',
         SelectedCategoryView.as_view(), name='selected_category'),
    re_path(r'^(?P<year>\w{0,})/(?P<month>\w{0,})/$',
            ArchiveView.as_view(), name='archive_posts'),
    path('<slug:blog_slug>', BlogPostView.as_view(), name='blog_post_view'),
    path('procurar/', blog_SearchView.as_view(), name='blog_search'),
