...
class Author(models.Model):
    ...
    descricao = RichTextUploadingField(blank=True, null=True, config_name='special', external_plugin_resources=[
...
class Equipa(models.Model):
    ...
    linkedin = models.URLField('youtube', null=True, blank=True)
    facebook = models.URLField('Facebook', null=True, blank=True)
    instagram = models.URLField('Instagram', null=True, blank=True)
    twiter = models.URLField('Twiter', null=True, blank=True)
...
class Post(models.Model):
    ...
    def email_to_admins_on_post_create(self):
        ...
        if not self.id and email:
            ...
            admin_emails = [
                admin_role.user.email for admin_role in admin_roles]
            user = self.user
    ...
    def get_absolute_url(self):
        ...
        return reverse('blog_post_view', kwargs=kwargs)
...
class PostHistory(models.Model):
    ...
    post = models.ForeignKey(
        Post, related_name='history', on_delete=models.CASCADE)
...
class Google(models.Model):
    user = models.ForeignKey(settings.AUTH_USER_MODEL,
                             related_name='google', on_delete=models.CASCADE)
...
class Facebook(models.Model):
    user = models.ForeignKey(settings.AUTH_USER_MODEL,
                             related_name='facebook', on_delete=models.CASCADE)
