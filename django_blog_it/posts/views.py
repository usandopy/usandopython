...
from django_blog_it.django_blog_it.models import Post, Category, Tags, Canal, Equipa, Author
from django_blog_it.django_blog_it.forms import FeedbackForm
...
from main.models import Categoria, Sobre
...
class SelectedCategoryView(ListView):
    template_name = "posts/detalhe-cat.html"
    context_object_name = "blog_posts"
...
class blog_SearchView(ListView):
    model = Post
    template_name = "posts/detalhe-sea.html"
...
def feedback(request):
    if request.method == 'POST':
        ...
        f = FeedbackForm()
    return render(request, 'posts/contact.html', {'form': f})
